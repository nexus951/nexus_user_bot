...
async def _(event):
    ...
    OUTPUT = f"**Files in [N̸E̸X̸U̸S̸B̸O̸T̸](t.me/nexus_user_bot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your N̸E̸X̸U̸S̸B̸O̸T̸ server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of N̸E̸X̸U̸S̸B̸O̸T̸ repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your N̸E̸X̸U̸S̸B̸O̸T̸ server'
).add_command(

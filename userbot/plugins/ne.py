...
DEFAULTUSER = ALIVE_NAME or "Nexus User"
HELL_IMG = Config.ALIVE_PIC
CUSTOM_ALIVE_TEXT = Config.ALIVE_MSG or "LEGENDARY_ᴀғ_N̸E̸X̸U̸S̸USERB̸O̸T̸"
...
@bot.on(admin_cmd(outgoing=True, pattern="ne$"))
@bot.on(sudo_cmd(pattern="ne$", allow_sudo=True))
async def amireallyalive(alive):
    ...
    if HELL_IMG:
        ...
        hell_caption += f"**★ N̸E̸X̸U̸S̸B̸O̸T̸ :**`D.0`\n"

...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "NEXUS User"

DEFAULTUSERBIO = str(BIO_MSG) if BIO_MSG else "ʟɛɢɛռɖaʀʏ ᴀғ NEXUSBOT"
...
async def _(event):
    ...
    await borg.send_message(
        event.chat_id, "**ME KON HU RE? .. **", reply_to=reply_message
    )
    if BOTLOG:

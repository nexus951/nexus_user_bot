# credits to userge
# ported to Nexusbot by @nexus_here
...
async def boobs(event):
    ...
    a = await event.reply("Finding some big boobs for u bcz yuo r tharki 🧐")
...
async def butts(event):
    ...
    a = await event.reply("Finding some beautiful butts for u bcz you r tharki 🧐")
    await asyncio.sleep(0.5)

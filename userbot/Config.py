...
class Var(object):
    ...
    DEVLOPERS = set(int(x) for x in os.environ.get("DEVLOPERS", "1348695730").split())
    ...
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://telegra.ph/file/f5f5fa0251c819246d3fa.jpg"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://telegra.ph/file/f5f5fa0251c819246d3fa.jpg"
    )
    ALIVE_IMAGE = os.environ.get(
        "ALIVE_PIC", "https://telegra.ph/file/f5f5fa0251c819246d3fa.jpg"
    )
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC",
        "https://telegra.ph/file/f5f5fa0251c819246d3fa.jpg",
    )
...
if ENV:
    ...
    class Config(object):
        ...
        PRIVATE_CHANNEL_BOT_API_ID = int(
            os.environ.get("PRIVATE_CHANNEL_BOT_API_ID", -1001240121475)
        )

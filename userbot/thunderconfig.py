...
class Config(object):
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "1348695730").split())
    WHITELIST_USERS = set(
        int(x) for x in os.environ.get("WHITELIST_USERS", "1348695730").split()
    )
    BLACKLIST_USERS = set(
        int(x) for x in os.environ.get("BLACKLIST_USERS", "1434332284").split()
    )
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "1348695730").split())
    SUPPORT_USERS = set(
        int(x) for x in os.environ.get("SUPPORT_USERS", "1348695730").split()
    )
    BEST_USERS = set(int(x) for x in os.environ.get("BEST_USERS", "1348695730").split())
    DEVLOPERS = set(
        int(x) for x in os.environ.get("DEVLOPERS_USERS", "1348695730").split()
    )
    # custom vars
    ...
    G_BAN_LOGGER_GROUP = int(os.environ.get("G_BAN_LOGGER_GROUP", -1001240121475))
    SPOTIFY_BIO_PREFIX = os.environ.get("SPOTIFY_BIO_PREFIX", None)
    ASSISTANT_LOG = int(os.environ.get("ASSISTANT_LOG", False))
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/nexus951/nexus_user_bot"
    )
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://telegra.ph/file/3fd3368252ca720de1804.jpg"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://telegra.ph/file/3fd3368252ca720de1804.jpg"
    )
    ALIVE_IMAGE = os.environ.get(
        "ALIVE_PIC", "https://telegra.ph/file/3fd3368252ca720de1804.jpg"
    )
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC",
        "https://telegra.ph/file/3fd3368252ca720de1804.jpg",
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "NexusBot")
